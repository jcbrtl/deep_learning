...
export ZSH="/home/kushaj/.oh-my-zsh"
...
alias kaggle='cd ~/Desktop/Kaggle'
...
__conda_setup="$('/home/kushaj/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/kushaj/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/kushaj/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/kushaj/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
conda activate dl
